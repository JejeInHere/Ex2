...
print ("\033[35m                      ╚════════════════════════════════════╝")
print ("\033[31m                   ╔════════════════════╦══════════════════════╗")                 
print ("\033[31m                   ║\033[32m TOOLS BY EXCRUSHER     \033[31m ║ \033[32m  EDITED 7/09/2022   \033[31m║")
print ("\033[31m                   ╚═══════════════════╦╩╦═════════════════════╝")
...
def spoofer():
    ...
    addr[1] = str(random.randrange(0, 791))
    addr[2] = str(random.randrange(0, 791))
    addr[3] = str(random.randrange(2, 254))
    addr[4] = str(random.randrange(2, 256))
    addr[5] = str(random.randrange(2, 254))
    addr[6] = str(random.randrange(2, 256))
    addr[7] = str(random.randrange(2, 298))
    addr[8] = str(random.randrange(2, 298))
    addr[9] = str(random.randrange(2, 761))
    addr[10] = str(random.randrange(2, 298))
    addr[11] = str(random.randrange(2, 256))
